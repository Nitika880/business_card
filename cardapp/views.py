...
from cardapp.models import User, PersonalUserCard, Qrcode
from cardapp.serializers import UserSerializer, PersonalCardSerializer, QrCodeSerializer, UserProfileSerilaizer
